/*
    ...
    "MPU6050_WLED_withFour_Switches_Pause_04090300.ino  04/09/2023 0300 EDT"  Adding Pause for sending of URLs.
...
void setup() {
  ...
  Serial.print("\n\n\nMPU6050_WLED_withFour_Switches_Pause_04090300.ino  04/09/2023 0300 EDT\n\n\n");
