/*
    ...
    "MPU6050_WLED_withFour_Switches_440700.ino  04/04/2023 0700 EDT"   Push Buttons Working.  Returned noMotion display of detals.
...
void print_wakeup_reason() {
  ...
  switch (wakeup_reason) {
    case ESP_SLEEP_WAKEUP_EXT0: Serial.println("Wakeup caused by external signal using RTC_IO"); switch2State = LOW;break;
...
void setup() {
  ...
  Serial.print("\n\n\nMPU6050_WLED_withThree_Switches_421100.ino  04/01/2023 1600 EDT\n\n\n");
...
void motion() {
  ...
  while (toogleSWITCH == 0) {
    ...
    seconds = map(potValue, 0, 4095, 1, 15000);;   //Experiment with range of seconds up or down.
